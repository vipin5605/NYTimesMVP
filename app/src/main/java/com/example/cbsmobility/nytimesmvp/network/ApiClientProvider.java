...
import com.example.cbsmobility.nytimesmvp.BuildConfig;
...
public class ApiClientProvider {
    ...
    public Retrofit provideApiClient(boolean isSoapRequest) throws NullURLEmptyException {
        if (!TextUtils.isEmpty(baseUrl)) {
            ...
            throw new NullURLEmptyException();
        }
    }
    ...
    private Gson createGson(){
       /* mGson = new GsonBuilder()
        ...
        Gson mGson = new GsonBuilder()
                .registerTypeAdapter(Result.class, new JSONDeserializer())
                .create();
        return mGson;
    }
