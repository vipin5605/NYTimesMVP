...
public class ArticleListAdapter<T> extends RecyclerView.Adapter<ArticleListAdapter.ViewHolder> {
    ...
    public ArticleListAdapter(List<T> data, ArticleListFragmentViewInterface articleListFragmentView, Picasso picasso, ArticleListItemClickListener articleListItemClickListener){
        mData = data;
    ...
    public void onBindViewHolder(ArticleListAdapter.ViewHolder holder, int position) {
        ...
        if(data != null && data instanceof Result){
            ...
            if(result != null && result.getMedia() != null && result.getMedia().get(0) != null && result.getMedia().get(0).getMediaMetadata() != null && result.getMedia().get(0).getMediaMetadata().get(0) != null )
